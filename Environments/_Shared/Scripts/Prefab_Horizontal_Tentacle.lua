...
function L0_0(A0_2)
  ...
  L2_4(L3_5)
  L2_4(L3_5, L4_6)
  L5_7 = "Sound_Marker_H_Tentacle_Controller"
  L5_7 = L3_5(L4_6, L5_7)
...
Prefab_Horizontal_Tentacle_AlwaysSetup = L0_0
function L0_0(A0_8, A1_9)
  ...
  if GetPrefabData(A0_8).BoilCount == GetPrefabData(A0_8).NumBoils or A1_9 == "Last" then
    ...
    if EndFunction == "None" then
      ...
      Print("*********HORIZONTAL TENTACLE EXIT FUNCTION CALLED*********")
      FireThread(_G[EndFunction], A0_8)
    end
    Prefab_Horizontal_Tentacle_Destroy(A0_8)
    DestroyEntity(A0_8)
    return
  end
...
Prefab_Horizontal_Tentacle_Boil_Damage = L0_0
function L0_0(A0_10)
...
Prefab_Horizontal_Tentacle_Destroy = L0_0
function L0_0(A0_17)
  ...
  L5_22 = "Sound_Marker_H_Tentacle_Controller"
  L5_22 = L3_20(L4_21, L5_22)
  L2_19(L3_20, L4_21, L5_22, L3_20(L4_21, L5_22))
  L2_19(L3_20)
end
Prefab_Horizontal_Tentacle_ForceDestroy = L0_0
